...
export const metadata = {
  ...
  description: "Internal LLM demo page for generating Moki Alpha Brief JSON.",
};
      ...
      <div className="mx-auto w-full max-w-[1180px] px-4 py-8 sm:px-6 sm:py-10">
        <section className="max-w-[860px]">
          ...
          <p className="mt-3 text-sm leading-7 opacity-75 sm:text-[15px]">
            输入 ticker，调用 POST /api/generate-brief，返回符合
            BriefDocument Schema 的结构化 JSON，并用现有 Moki Alpha Brief
            页面组件进行预览。Fast 使用 deepseek-chat；Deep Reasoning 使用
            deepseek-reasoner。当前不保存结果，也不生成真实公开分享链接。
          </p>
        </section>
